...
- *Проект и его архитектуру понимает один человек* (чаще всего изначальный автор) -
  сложно добавить человека в команду; у каждого свое мнение как писать код.

- *Тьма-тьмущая неявных сайд-эффектов при разработке/рефакторинге* (всё зависит от всего) -
  большая связанность компонентов; "обновляю стор одной страницы, а отвалился функционал на другой"
