...
Методология для проектирования *frontend проектов*, нацеленная [**на разделение приложения согласно бизнес-логике и областям ответственности.**](docs/concepts/app-splitting.md)
...
>
> Но для фронтенда - [крайне трудно найти](./docs/about/motivation.md) устоявшиеся и конкретные подходы

## Overview

Методология призвана **упростить и стандартизировать декомпозицию логики для больших и долгоживужих проектов.**

Для этого она вводит ряд [концепций](/docs/concepts/readme.md) и [абстракций](/docs/references/abstractions.md), на которых *может базироваться* архитектура от проекта к проекту:

- для более **явного распределения бизнес-логики по модулям приложения**
    > Согласно [*скоупу влияния*, *бизнес-ответственности* и *техническому назначению*](./docs/concepts/app-splitting.md)
    >
    > Благодаря этому *архитектура стандартизируется и становится более легкой для ознакомления*
- для более **легкой адаптации проекта к возникающим новым условиям**
    ...
    >
    > Благодаря этому *под новые требования / обстоятельства можно независимо добавлять / изменять функциональность приложения без непредвиденных последствий*
...
- для **масштабирования проекта и команды**
    > Увеличение функциональности ведет к гораздо меньшему усложнению проекта, т.к. вся логика распределена детерминировано и изолировано
    >
    > Благодаря этому *легко добавлять и онбордить новых людей в команду, а также расширять функциональность проекта*

## Concepts

- [`Public API`](./docs/concepts/public-api.md)
- [`Isolation`](./docs/concepts/cross-communication.md)
- [`Needs Driven`](./docs/concepts/understanding-needs.md)
...
Подробнее в ["Абстракции методологии"](/docs/get-started/abstractions.md) и ["Разбиение приложения"](/docs/concepts/app-splitting.md)
