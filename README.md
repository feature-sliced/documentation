...
> **Примечание:** Методология не привязана к конкретной технологии и применима *к любым фронтенд-проектам* в целом.
>
...
- [`Docs` Документация методологии](docs)
...
- [`Contributing` Как можно помочь?][refs-contributing]
