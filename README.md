...
Также, неверно принятые решения зачастую приводят [к проблемам масштабируемости проекта и команды](./about/architecture.md#%EF%B8%8F-проблемы).
...
> Да, практик и паттернов - много *(SOLID, GRASP, DDD, ...)*, но устоявшиеся и конкретные подходы для фронтенда - [крайне трудно найти](./about/motivation.md)
