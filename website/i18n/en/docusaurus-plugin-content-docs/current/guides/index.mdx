...
<p class="summary">
Practical guides and examples on the use of Feature Sliced. There is also describe migration guides and a handbook of vicious practices. It is most useful when you are trying to implement something specific or want to look at the methodology "in battle"
</p>
