...
2. It should also be understood that the examples below are abstract and synthetic, and are formed purely to demonstrate the concepts of the methodology
