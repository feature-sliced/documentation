...
**Note:** **Mevcut kullanıcı** (current user) bazen "viewer" veya "me" olarak da adlandırılır. Bunun amacı; yetkileri ve özel bilgileri olan kimliği doğrulanmış tek kullanıcıyı, herkes tarafından erişilebilen bilgilere sahip tüm kullanıcılar listesinden ayırt etmektir.
