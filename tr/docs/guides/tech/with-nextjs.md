...
**Caution:** Çakışmaları önlemek için, hangi yönlendiriciyi (router) kullanırsanız kullanın, **hem** `app` hem de `pages` FSD katmanlarını `_app` ve `_pages` olarak yeniden adlandırın.
