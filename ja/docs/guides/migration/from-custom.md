...
エンティティとフィーチャーは互いに独立している必要があります。ビジネス領域に組み込まれたエンティティ間の関係がある場合は、[ビジネスエンティティに関するガイド](/ja/docs/guides/examples/types.md#business-entities-and-their-cross-references)を参照して、これらの関係を整理する方法を確認してください。
