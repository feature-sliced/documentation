...
> Каждая сущность в рамках методологии должна быть спроектирована так, чтобы ее было удобно использовать и интегрировать в приложение, при этом оставляя саму систему устойчивой к изменениям в отдельных сущностях.
---
