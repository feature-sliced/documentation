...
- В силу специфики слоя, используется не всегда - **только когда логика размывается в страницах** и нужно **отдельное управление контекстом** на сразу нескольких страницах
