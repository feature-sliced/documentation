...
> `WIP:` Поскольку на данный момент - работа над текущей версией методологии в процессе, ее внедрение **в рабочие проекты стоит проводить крайне осторожно** *(только на свой страх и риск)*
