...
**Caution:** This guide discourages using the Widgets layer.
...
**Caution:** This layer has been deprecated. The current version of the spec recommends avoiding it and moving its contents to `features` and `app` instead.
