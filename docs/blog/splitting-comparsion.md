...
[ext-motivation]: ../about/motivation.md
...
> 
> И даже их каждый [интерпретирует *по-своему*][ext-motivation] - и это еще одна *проблема*
...
- [Глоссарий методологии](/docs/references/knowledge-types.md)
