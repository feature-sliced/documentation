...
> **Примечание:** Постараемся сконцентрироваться не на реализации каждого модуля, а на последовательной композиции логики
...
[ext-pluralsight--flat]: https://www.pluralsight.com/guides/how-to-organize-your-react-+-redux-codebase#module-theflatstructure@import "./styles/index.scss";
```
