...
If there are connections between the entities (for example, the Country entity has a field-list of City entities), then you can use the [public API for cross-imports](/uz/docs/reference/public-api.md#public-api-for-cross-imports) or consider the alternative solution below.
...
### Benefits of using a Query Factory[​](#benefits-of-using-a-query-factory "Sarlavhaga to'g'ridan-to'g'ri havola")
...
## Additional advice for organizing RQ[​](#additional-advice-for-organizing-rq "Sarlavhaga to'g'ridan-to'g'ri havola")
