...
## Type validation schemas and Zod[​](#type-validation-schemas-and-zod "Sarlavhaga to'g'ridan-to'g'ri havola")
...
## Ambient declaration files (`*.d.ts`)[​](#ambient-declaration-files-dts "Sarlavhaga to'g'ridan-to'g'ri havola")
