...
To keep examples focused, we omit form interaction and validation. For details on libraries like Zod or Valibot, refer to the [Type Validation and Schemas](/uz/docs/guides/examples/types.md#type-validation-schemas-and-zod) article.
...
For more details on how to work with server state libraries, refer to [React Query article](/uz/docs/guides/tech/with-react-query.md)
