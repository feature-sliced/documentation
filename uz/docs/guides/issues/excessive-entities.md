...
## How to keep `entities` layer clean[​](#how-to-keep-entities-layer-clean "Sarlavhaga to'g'ridan-to'g'ri havola")

### 0. Consider having no `entities` layer[​](#0-consider-having-no-entities-layer "Sarlavhaga to'g'ridan-to'g'ri havola")
...
### 1. Avoid preemptive slicing[​](#1-avoid-preemptive-slicing "Sarlavhaga to'g'ridan-to'g'ri havola")
...
### 2. Avoid Unnecessary Entities[​](#2-avoid-unnecessary-entities "Sarlavhaga to'g'ridan-to'g'ri havola")
...
### 3. Exclude CRUD Operations from Entities[​](#3-exclude-crud-operations-from-entities "Sarlavhaga to'g'ridan-to'g'ri havola")
...
### 4. Store Authentication Data in `shared`[​](#4-store-authentication-data-in-shared "Sarlavhaga to'g'ridan-to'g'ri havola")
...
For more details on implementing authentication, see [the Authentication guide](/documentation/uz/docs/guides/examples/auth.md).

### 5. Minimize Cross-Imports[​](#5-minimize-cross-imports "Sarlavhaga to'g'ridan-to'g'ri havola")
