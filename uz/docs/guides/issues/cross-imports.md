...
## Why is this a code smell?[​](#why-is-this-a-code-smell "Sarlavhaga to'g'ridan-to'g'ri havola")
...
## Entities layer cross-imports[​](#entities-layer-cross-imports "Sarlavhaga to'g'ridan-to'g'ri havola")
...
For details about `@x`, see the [Public API documentation](/documentation/uz/docs/reference/public-api.md).

For concrete examples of cross-references between business entities, see:

* [Types guide — Business entities and their cross-references](/documentation/uz/docs/guides/examples/types.md#business-entities-and-their-cross-references)
* [Layers reference — Entities](/documentation/uz/docs/reference/layers.md#entities)

## Features and widgets: Multiple strategies[​](#features-and-widgets-multiple-strategies "Sarlavhaga to'g'ridan-to'g'ri havola")
...
### Strategy A: Slice merge[​](#strategy-a-slice-merge "Sarlavhaga to'g'ridan-to'g'ri havola")
...
### Strategy B: Push shared domain flows down into `entities` (domain-only)[​](#strategy-b-push-shared-domain-flows-down-into-entities-domain-only "Sarlavhaga to'g'ridan-to'g'ri havola")
...
For more guidance, see [Layers reference — Entities](/documentation/uz/docs/reference/layers.md#entities).

### Strategy C: Compose from an upper layer (pages / app)[​](#strategy-c-compose-from-an-upper-layer-pages--app "Sarlavhaga to'g'ridan-to'g'ri havola")
...
#### Basic composition example (React):[​](#basic-composition-example-react "Sarlavhaga to'g'ridan-to'g'ri havola")
...
#### Render props example (React):[​](#render-props-example-react "Sarlavhaga to'g'ridan-to'g'ri havola")
...
#### Slots example (Vue):[​](#slots-example-vue "Sarlavhaga to'g'ridan-to'g'ri havola")
...
### Strategy D: Cross-feature reuse only via Public API[​](#strategy-d-cross-feature-reuse-only-via-public-api "Sarlavhaga to'g'ridan-to'g'ri havola")
...
#### Example code:[​](#example-code "Sarlavhaga to'g'ridan-to'g'ri havola")
...
## When should cross-imports be treated as a problem?[​](#when-should-cross-imports-be-treated-as-a-problem "Sarlavhaga to'g'ridan-to'g'ri havola")
...
## How strict you are is a team/project decision[​](#how-strict-you-are-is-a-teamproject-decision "Sarlavhaga to'g'ridan-to'g'ri havola")
...
## References[​](#references "Sarlavhaga to'g'ridan-to'g'ri havola")
