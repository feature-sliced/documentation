...
Для получения дополнительной информации, а также примеров, см. страницу [про слайсы](/ru/docs/reference/layers.md#entities) в разделе Reference.
...
Вы не можете импортировать одну фичу из другой фичи, это запрещено [**правилом импортов для слоёв**](/ru/docs/reference/layers.md#import-rule-on-layers).
...
Ответили [здесь](/ru/docs/guides/examples/auth.md)
