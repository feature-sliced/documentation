...
![Иерархия концепций FSD, описанная ниже](/ru/assets/images/visual_schema-e826067f573946613dcdc76e3f585082.jpg)
...
* **Хотите разобраться в том, как мыслить по-FSD-шному?** Прочтите [Туториал](/ru/docs/get-started/tutorial.md).
* **Предпочитаете учиться на примерах?** У нас их много в разделе [Примеры](/ru/examples.md).
