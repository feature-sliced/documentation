...
<StaticImage path="/img/graphic-nested-slices.svg" alt="Функции 'compose', 'like' и 'delete' сгруппированы в папку 'post'. В этой папке также есть файл 'some-shared-code.ts', который зачеркнут, чтобы показать, что это запрещено." />
...
[layers--layer-definitions]: /ru/docs/reference/layers#layer-definitions
[layers--import-rule]: /ru/docs/reference/layers#import-rule-on-layers
[ref-public-api]: /ru/docs/reference/public-api
