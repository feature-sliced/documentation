...
## How to keep `entities` layer clean[​](#how-to-keep-entities-layer-clean "Прямая ссылка на этот заголовок")

### 0. Consider having no `entities` layer[​](#0-consider-having-no-entities-layer "Прямая ссылка на этот заголовок")
...
### 1. Avoid preemptive slicing[​](#1-avoid-preemptive-slicing "Прямая ссылка на этот заголовок")
...
### 2. Avoid Unnecessary Entities[​](#2-avoid-unnecessary-entities "Прямая ссылка на этот заголовок")
...
### 3. Exclude CRUD Operations from Entities[​](#3-exclude-crud-operations-from-entities "Прямая ссылка на этот заголовок")
...
### 4. Store Authentication Data in `shared`[​](#4-store-authentication-data-in-shared "Прямая ссылка на этот заголовок")
...
For more details on implementing authentication, see [the Authentication guide](/documentation/ru/docs/guides/examples/auth.md).

### 5. Minimize Cross-Imports[​](#5-minimize-cross-imports "Прямая ссылка на этот заголовок")
