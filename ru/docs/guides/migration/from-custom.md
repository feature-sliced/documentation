...
Сущности и фичи должны быть независимы друг от друга. Если ваша бизнес-область содержит встроенные связи между сущностями, обратитесь к [руководству по бизнес-сущностям](/ru/docs/guides/examples/types.md#business-entities-and-their-cross-references) за советом по организации этих связей.
