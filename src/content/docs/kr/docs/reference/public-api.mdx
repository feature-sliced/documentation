...
<figure>
    <img src="../../../../../../static/img/circular-import-light.svg" data-theme-only="light" width="60%" alt="세 파일이 서로 원형으로 import하는 모습" />
    <img src="../../../../../../static/img/circular-import-dark.svg" data-theme-only="dark" width="60%" alt="세 파일이 서로를 원형으로 import하고 있는 예시입니다." />
    <figcaption>
