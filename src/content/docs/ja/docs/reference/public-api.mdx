...
<figure>
    <img src="../../../../../../static/img/circular-import-light.svg" data-theme-only="light" width="60%" alt="三つのファイルが循環的にインポートしている" />
    <img src="../../../../../../static/img/circular-import-dark.svg" data-theme-only="dark" width="60%" alt="三つのファイルが循環的にインポートしている" />
    <figcaption>
