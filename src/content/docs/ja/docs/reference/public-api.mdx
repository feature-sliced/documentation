...
<figure>
    <img src="../../../../../../static/img/circular-import-light.svg#light-mode-only" width="60%" alt="三つのファイルが循環的にインポートしている" />
    <img src="../../../../../../static/img/circular-import-dark.svg#dark-mode-only" width="60%" alt="三つのファイルが循環的にインポートしている" />
    <figcaption>
