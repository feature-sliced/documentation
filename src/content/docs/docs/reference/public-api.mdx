...
<figure>
    <img src="../../../../../static/img/circular-import-light.svg#light-mode-only" width="60%" alt="Three files importing each other in a circle" />
    <img src="../../../../../static/img/circular-import-dark.svg#dark-mode-only" width="60%" alt="Three files importing each other in a circle" />
    <figcaption>
