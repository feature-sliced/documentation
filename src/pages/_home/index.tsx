...
export default function HomePage() {
    ...
    return (
        ...
        <Layout title="Welcome" description="Architectural methodology for frontend projects">
            ...
            <main>
                <section
                    className={clsx(styles.section, styles.sectionText, styles.limitations)}
                    id="scheme-limitations"
                >
                    <h2 className={styles.text}>
                        Our aim is to cover the architectural needs of the{" "}
                        <span className="text--primary">vast majority of front-end projects</span>
                    </h2>
                    <br />
                ...
                <section className={clsx(styles.section, styles.sectionText, styles.profits)}>
                    <h2 className={styles.text}>
                        Less <span className="text--red">pain</span>, more{" "}
                    ...
                    <div className={styles.profictsList}>
                        <div className={styles.card}>
                            ...
                            <div className={styles.cardContent}>
                                ...
                                <p>
                                    Just know that it makes your code{" "}
                                    <span className="text--green">easier to unit-test</span> and
                                    refactoring is much more{" "}
                                    <span className="text--blue">predictable</span>
                                </p>
                            </div>
                        </div>
                        <div className={styles.card}>
                            ...
                            <div className={styles.cardContent}>
                                ...
                                <p>
                                    You’ll <span className="text--green">feel right</span> at home
                                    in the codebase. Get{" "}
                                    <span className="text--blue">straight to business</span>, skip
                ...
                <section className={clsx(styles.section, styles.sectionText, styles.companies)}>
                    <h2 className={styles.text}>
                        It’s <span className="text--red">dangerous</span> to go alone
                    </h2>
                    <p>
                        But you don’t have to. These companies are already using Feature-Sliced
                        Design:
                    </p>
                    <Companies />
                </section>
                <section className={clsx(styles.section, styles.sectionText, styles.nowar)}>
                    <h2 className={styles.text}>
                        The FSD team stands with Ukraine <div className={styles.flag} />
                    </h2>
                    <p>
                        The Feature-Sliced Design team unanimously despises the invasion into
                        Ukraine led by the Russian government.
                    </p>
                    <p>
                        <span className="text--primary">Can and want to help?</span> The best way is
                        to seek out a local organization that supports Ukrainian refugees in your
                        country and help someone directly.
                    </p>
                </section>
                <section className={clsx(styles.section, styles.sectionText, styles.cta)}>
                    ...
                    <div className={styles.ctaActions}>
                        <KeyLink href="/docs" keyIcon={KeyLink.Enter} isActive>
                            Dive into the docs
                        </KeyLink>
                        <KeyLink href="/docs" keyIcon="E">
                            Discover ecosystem
                        </KeyLink>
                        <KeyLink href="/docs" keyIcon="S">
                            Explore realworld examples
                        </KeyLink>
                        <KeyLink href="/docs" keyIcon="D">
