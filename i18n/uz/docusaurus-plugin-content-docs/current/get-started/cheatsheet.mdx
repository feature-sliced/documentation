...
## Роль и значение декомпозиции {#the-role-and-meaning-of-decomposition}

> Проблематика, Что будет если игнорировать, Чем может помочь, Почему это важно, Про устойчивость к изменениям

## Как определять скоуп ответственности {#how-to-determine-the-scope-of-responsibility}
...
### Дробление макета {design-mockup}
