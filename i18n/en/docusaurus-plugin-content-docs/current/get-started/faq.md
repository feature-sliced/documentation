...
Answered [here](/docs/concepts/decomposition#group-slices)
...
See also [comparison reference] (/docs/concepts/decomposition/layers), [viewer implementation of logic by layers](/docs/guides/examples/auth)
...
The methodology strongly recommends against doing this, since [each module has a corresponding place in the structure](/docs/concepts/decomposition)
