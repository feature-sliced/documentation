...
有关更多信息和示例，请参阅 [slices](/zh/docs/reference/layers.md#entities) 的参考页面。
...
您不能从一个 feature 导入另一个 feature，这被 [**layers 上的导入规则**](/zh/docs/reference/layers.md#import-rule-on-layers) 禁止。
...
它帮助您和您的团队在主要价值组件方面快速概览项目。标准化架构有助于加快入职速度并解决关于代码结构的争议。请参阅[动机](/zh/docs/about/motivation.md)页面了解更多关于为什么创建 FSD 的信息。
...
在[这里](/zh/docs/guides/examples/auth.md)有答案
